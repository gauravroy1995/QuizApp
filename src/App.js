      ...
      return (
        <div className="text-center">
          ...
          <div className="hyperlink-button">
            <a onClick={this.props.resetGame} href="#">
              Restart
            </a>
          </div>
        </div>
...
class Option extends React.Component {
  render() {
    return (
      <div>
        <a href="#" onClick={this.props.triggerProcess} className="option-card">
        ...
        <div className="row">
          <div className="offset-lg-2 col-lg-7 col-md-12">
            <QuestionPanel
              activeGame={this.state.activeGame}
              question={
                this.state.questionsAnswer[this.state.currentIndex].question
              }
              resetGame={this.resetGame}
            />
            <div className={this.state.activeGame ? "visible" : "hidden"}>
              {options}
            </div>
          </div>
